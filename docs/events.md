...
A single-line Input is the visible edge of this: it has no line to move to, so it declines
Up and Down and they reach focus navigation instead of being swallowed.
